...
# Wear OS receiver sources are kept in android_src/ and android_manifest/.
# They are not wired into the Buildozer APK until python-for-android
# Google Play Services dependency compatibility is verified.
