...
# hostpython3 и python3 должны совпадать! Kivy 2.3.0 несовместим с Python 3.14
requirements = hostpython3==3.12.9,python3==3.12.9,kivy==2.3.0,numpy,pyjnius,kivymd
